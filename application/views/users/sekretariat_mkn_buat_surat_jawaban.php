<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Buat Surat Jawaban Ketua ke APH</li>
    </ol>

    <h1 class="page-header">Buat Surat Jawaban Ketua ke APH</h1>
        ...
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?= ucfirst(htmlspecialchars($perkara->tahapan)); ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>Form Surat Jawaban Ketua ke APH</strong>
        </div>
        <div class="panel-body">
            <form action="<?= site_url('sekretariat_mkn/simpan_surat_jawaban'); ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_surat" class="form-control" required
                           placeholder="Contoh: W.20.MKN.01.02-456/2025">
                </div>

                <div class="form-group">
                    <label>Perihal</label>
                    <input type="text" name="perihal" class="form-control"
                           placeholder="Jawaban atas permohonan APH terkait Notaris ...">
                </div>

                <div class="form-group">
                    <label>Lampiran (PDF/JPG/PNG, maks 4MB)</label>
                    <input type="file" name="lampiran" class="form-control" accept=".pdf,.jpg,.jpeg,.png">
                    <p class="help-block">Opsional — upload surat resmi jika sudah ada file-nya.</p>
                </div>
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn btn-primary">
                        Simpan Surat Jawaban & Naikkan Tahap
                    </button>
                </div>
            </form>
        </div>
