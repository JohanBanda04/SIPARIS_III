<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Perkara Tahap Penyelidikan</li>
    </ol>

    <h1 class="page-header">Perkara Tahap Penyelidikan</h1>
        ...
        <div class="panel-body">
            ...
            <?php if (empty($rows)): ?>
                <div class="alert alert-info">
                    Belum ada perkara di tahap penyelidikan.
                </div>
            <?php else: ?>
                        ...
                        <?php $no=1; foreach ($rows as $r): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= site_url('sekretariat_mkn/naik_penyidikan/'.$r->id_perkara); ?>"
