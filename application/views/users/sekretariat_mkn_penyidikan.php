<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Perkara Tahap Penyidikan</li>
    </ol>

    <h1 class="page-header">Perkara Tahap Penyidikan</h1>
        ...
        <div class="panel-body">
            <?php if (empty($rows)): ?>
                <div class="alert alert-info">
                    Belum ada perkara di tahap penyidikan.
                </div>
            <?php else: ?>
                        ...
                        <?php $no=1; foreach ($rows as $r): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= site_url('sekretariat_mkn/buat_surat/'.$r->id_perkara); ?>"
                                       class="btn btn-success btn-xs">
                                        Surat Pemanggilan
                                    </a>
                                    <a href="<?= site_url('sekretariat_mkn/buat_surat_jawaban/'.$r->id_perkara); ?>"
                                       class="btn btn-warning btn-xs">
                                        Surat Jawaban ke APH
                                    </a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
